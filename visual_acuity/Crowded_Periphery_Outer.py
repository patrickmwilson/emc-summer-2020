...
def instructions():
    ...
    genDisplay({'text': 'on the outside of the plus (e, p, b),',\
...
for pair in pairs: # Loop through the list of pairs
    ...
    while not trialInfo['stairCaseCompleted']:
        ...
        trialInfo['thisResponse'] = checkResponse(response, outerChar)
