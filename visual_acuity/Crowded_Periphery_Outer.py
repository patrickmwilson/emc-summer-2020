...
# subject is tasked with identifying the character on the outside of the plus.
# To see a photo of this experiment, open the 'cpo.png' file within the 
...
# from 'E', 'B', and 'P'. Returns the target character (the outer character of 
# the plus pattern, farthest from the center of the screen)
#
#  P
# EEB
#  B
...
for pair in pairs:  # Loop through the list of pairs
    ...
    while not stairCaseCompleted:
        ...
        # characters, return the outer character of the pattern
