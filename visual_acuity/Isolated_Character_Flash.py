# Isolated Character
#
# Displays a flashing single character in the peripheral region for the subject to 
...
if recordData:
    ...
    expName = 'Isolated Character Flash'
...
for pair in pairs: # Loop through the list of pairs
    ...
    while not trialInfo['stairCaseCompleted']:
        ...
        #Generate a display object for the masking character
